...
cubo=[40-180*asa+(0+asa_y/2*190)*i 40-180*asa+(190-asa_y/2*190)*i];
silueta_cubo(1,:)=[cubo(1)-(190i-(cubo(2)-cubo(1)))/2-asa*180/190*exp(i*pi/2)*(cubo(2)-cubo(1))/asa_y,...
    cubo(2)+(190i-(cubo(2)-cubo(1)))/2-asa*180/190*exp(i*pi/2)*(cubo(2)-cubo(1))/asa_y,...
    cubo(2)+(190i-(cubo(2)-cubo(1)))/2+(1-asa)*180/190*exp(i*pi/2)*(cubo(2)-cubo(1))/asa_y,...
    cubo(1)-(190i-(cubo(2)-cubo(1)))/2+(1-asa)*180/190*exp(i*pi/2)*(cubo(2)-cubo(1))/asa_y,...
    cubo(1)-(190i-(cubo(2)-cubo(1)))/2-asa*180/190*exp(i*pi/2)*(cubo(2)-cubo(1))/asa_y];
        ...
        for c1x=cuadrante1(1)-trapez*100/375*(c1y-375):1/n*(cuadrante1(2)-cuadrante1(1)+trapez*100/375*(c1y-375)):cuadrante1(2)
            ...
            for c2y=cuadrante2(3):1/n*(cuadrante2(4)-cuadrante2(3)):cuadrante2(4)
                for c2x=cuadrante2(1)-trapez*100/375*(c2y-375):1/n*(cuadrante2(2)-cuadrante2(1)+trapez*100/375*(c2y-375)):cuadrante2(2)
                    ...
                    alfa=angle(cubo(iter,2*k)-cubo(iter,2*k-1));
                    
                    centros(k,:)=[c1 c2];
                    
                    % Condiciones de no invasión del camión, etc
                    while ((imag(cubo(iter,2*k-1)-(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2)<(0-375)/(100-0)*real(cubo(iter,2*k-1)-(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2)))+375 ...
                            || (imag(cubo(iter,2*k-1)-(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))>375) ...
                            && imag(cubo(iter,2*k-1)-(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))>=0 ...
                            && real(cubo(iter,2*k-1)-(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))<400)) ... % Fin restricciones esquina 1.
                            && (imag(cubo(iter,2*k)+(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))<(0-375)/(100-0)*real(cubo(iter,2*k)+(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))+375 ...
                            || imag(cubo(iter,2*k)+(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))>375) ...
                            && real(cubo(iter,2*k)+(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))<400 ...
                            && real(cubo(iter,2*k)+(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2+(1-asa)*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))<=400 ... 
                            && bloqueo==0 ...
                            && angle(cubo(iter,2*k)-cubo(iter,2*k-1))>=alfa_f

                        % Incremento de ángulo
                        theta=theta-0.5*(pi/180);
                        iter=iter+1;
                        ...
                        b = 190*(1-asa_y); % Radio del primer círculo
...
%                             (190i-(cubo(2)-cubo(1)))/2
                            silueta_cubo(iter,5*k-4:5*k)=[cubo(iter,2*k-1)-(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*180*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2),...
                                cubo(iter,2*k)+(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*180*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2),...
                                cubo(iter,2*k)+(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2+(1-asa)*180*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2),...
                                cubo(iter,2*k-1)-(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2+(1-asa)*180*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2),...
                                cubo(iter,2*k-1)-(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*180*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2)];
                            ...
                            if imag(cubo(iter,2*k-1)-(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))<375
                            ...
                            if real(cubo(iter,2*k)+(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2-asa*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))>=133 ...
                                    && real(cubo(iter,2*k-1)-(190*(cos(alfa)+i*(sin(alfa)))-(cubo(iter,2*k)-cubo(iter,2*k-1)))/2+(1-asa)*190*(cos(alfa)+i*(sin(alfa)))*exp(i*pi/2))<=400
